        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-16 items-center border-b border-black/10 pb-12">
            ...
            <div className="flex flex-col justify-center">
                <div className="flex items-center space-x-2 mb-4 text-xs font-bold tracking-widest uppercase text-accent">
                    <span className="px-2 py-1 border border-accent">{category || "Top Story"}</span>
                    <span className="text-secondary font-medium normal-case">{getTimeAgo(date)}</span>
                </div>

                <Link to={`/article/${id}`}>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold leading-tight mb-6 hover:text-accent transition-colors">
                        {title}
                    </h2>
                </Link>
                ...
                <div className="flex items-center justify-between">
                    <div className="text-sm font-medium">
                        By <span className="text-primary font-bold">{author || "Daily Agent"}</span>
                    </div>
                    <Link to={`/article/${id}`} className="group flex items-center text-sm font-bold tracking-wider hover:text-accent transition-colors">
                        READ FULL STORY
